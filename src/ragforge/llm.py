"""Dual LLM backend behind one interface.

Local Ollama for free iteration, Anthropic for quality. Nothing above this module
knows or cares which one is active - swap with LLM_BACKEND in .env.
"""
